...
const mywork_data = [
    ...
    { w_no: "02", w_name: "My Portfolio", w_desc: "Frontend web app built with React and custom CSS. Focused on responsive design and interactive UI.", w_tech: "React, CSS", w_img: project2_img, w_video: null, w_url: "https://github.com/heshan622/My-Portfolio" },
